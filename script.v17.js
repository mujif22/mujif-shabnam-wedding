...
(function(){
  try{
    if(!document.querySelector(".card-container.welcome-gate, .welcome-gate")){
...
const I18N={
  ...
  hi:{
    ...
    host_invite:"आपको निकाह &amp; वलीमा में<br>सादर आमंत्रित करते हैं",
    host_note:"आपकी मौजूदगी हमारे लिए इज़्ज़त और दुआ होगी, इंशाअल्लाह।",
