...
const I18N={
  ...
  hi:{
    ...
    tap_to_open:"निमंत्रण खोलें",
    tap_again_music:"संगीत के लिए फिर टैप करें",
    host_blessing:"अल्लाह की रहमतों के साथ",
    host_eyebrow:"खानदान",
    host_families:"आतार <em>&</em> शेख",
    host_invite:"आपको सादर आमंत्रित करते हैं<br>निकाह व वलीमा की पाक तक़रीब में",
    host_note:"आपकी मौजूदगी हमारे लिए इज़्ज़त होगी, इंशाअल्लाह।",
    gate_sub:"ईमान से जुड़े • मोहब्बत से बंधे",
    ...
    ayah_translation:"“और अल्लाह की निशानियों में से ये भी है कि उसने तुम्हारे लिए तुम्हारी ही जाति से जोड़े बनाए, ताकि तुम उनके पास सुकून पाओ; और तुम्हारे बीच मोहब्बत और रहमत रख दी।”",
    ayah_ref:"क़ुरआन • ३०:२१",
    blessing_note:"अल्लाह इस पाक रिश्ते को मोहब्बत, सुकून और बरकत से नवाज़े।",
    ...
    open_maps:"लोकेशन देखें",
    nikah_qr:"निकाह लोकेशन स्कैन करें",
    nikah_qr_alt:"निकाह लोकेशन का क्यूआर कोड",
    walima:"वलीमा",
    ...
    walima_qr:"वलीमा लोकेशन स्कैन करें",
    walima_qr_alt:"वलीमा लोकेशन का क्यूआर कोड",
    ...
    closing_title:"हमारी ख़ुशी में<br><em>शामिल होने के लिए</em>",
