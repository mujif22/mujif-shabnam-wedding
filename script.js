...
function syncAppViewport(force){
  if(appHLocked && !force) return;
  const h=Math.max(1, Math.round(window.innerHeight || 0));
  const w=Math.max(1, Math.round(window.innerWidth || 0));
  if(h < 80) return;
...
window.addEventListener("orientationchange", ()=>{
  appHLocked=false;
  window.setTimeout(()=>syncAppViewport(true), 150);
  window.setTimeout(()=>syncAppViewport(true), 450);
});
/* Ignore visualViewport resize/scroll — it fights manual scrolling on phones */
window.addEventListener("load", ()=>syncAppViewport(true));
window.setTimeout(()=>syncAppViewport(true), 100);
...
const I18N={
  ...
  hi:{
    wedding_invitation:"جشنِ شادی",
    names_amp:"مجیف <em>&</em> شبنم",
    tap_to_open:"کھولنے کے لیے ٹیپ کریں",
    tap_again_music:"موسیقی کے لیے دوبارہ ٹیپ کریں",
    host_blessing:"اللہ تعالیٰ کی رحمتوں کے ساتھ",
    host_eyebrow:"خاندانِ",
    host_families:"عطار <em>&</em> شیخ",
    host_invite:"آپ کو بصدِ احترام مدعو کرتے ہیں<br>مقدّس تقریبِ نکاح و ولیمہ میں",
    host_note:"آپ کی تشریف آوری ہمارے لیے باعثِ عزت و برکت ہوگی، ان شاء اللہ۔",
    gate_sub:"ایمان میں جڑیں • محبت میں پیمان",
    gate_nikah_row:"<b>نکاح</b><span>27 ستمبر 2026</span>",
    gate_walima_row:"<b>ولیمہ</b><span>29 ستمبر 2026</span>",
    ayah_eyebrow:"ایک خوبصورت آیت",
    ayah_translation:"“اور اس کی نشانیوں میں سے یہ ہے کہ اس نے تمہارے لیے تمہاری ہی جنس سے جوڑے پیدا کیے تاکہ تم ان کے پاس سکون پاؤ، اور تمہارے درمیان محبت اور رحمت رکھ دی۔”",
    ayah_ref:"قرآن • ۳۰:۲۱",
    blessing_note:"اللہ اس اتحاد کو محبت، سکون، برکت اور بے پناہ خوشیوں سے نوازے۔",
    couple_eyebrow:"دولہا و دلہن",
    couple_title:"ایک نیا باب<br><em>ساتھ شروع</em>",
    couple_lead:"دو دل • ایک نیت • اللہ کی حفاظت میں",
    groom_label:"نورِ چشم",
    groom_name:"مجیف",
    groom_parent:"ولد : عطار غفور حسن",
    groom_place:"ساکن : ایٹ<br>تحصیل بھوم، ضلع دھاراشیو",
    bride_label:"نورِ چشمی",
    bride_name:"شبنم",
    bride_parent:"بنت : شیخ رحیم انصر",
    bride_place:"ساکن : دِندرڈ<br>تحصیل ماج لگاؤں، ضلع بیڑ",
    nikah:"نکاح",
    nikah_month_year:"ستمبر<br>2026",
    nikah_day:"اتوار",
    nikah_time:"صبح 11:30 بجے",
    nikah_venue:"سواراج منگل کاریالیہ",
    nikah_address:"تیلگاؤں روڈ، دِندرڈ<br>تحصیل ماج لگاؤں، ضلع بیڑ",
    open_maps:"نقشہ میں کھولیں",
    nikah_qr:"نکاح کے مقام کے لیے اسکین کریں",
    nikah_qr_alt:"نکاح کے مقام کا کیو آر کوڈ",
    walima:"ولیمہ",
    walima_month_year:"ستمبر<br>2026",
    walima_day:"منگل",
    walima_time:"ظہر کے بعد",
    walima_venue:"رودرا منگل کاریالیہ",
    walima_address:"پکھروڈ روڈ، ایٹ<br>تحصیل بھوم، ضلع دھاراشیو",
    walima_qr:"ولیمہ کے مقام کے لیے اسکین کریں",
    walima_qr_alt:"ولیمہ کے مقام کا کیو آر کوڈ",
    countdown_eyebrow:"نکاح کی الٹی گنتی",
    countdown_title:"انتظار<br><em>اب تھوڑا سا</em>",
    unit_days:"دن",
    unit_hours:"گھنٹے",
    unit_minutes:"منٹ",
    unit_seconds:"سیکنڈ",
    countdown_target:"27 ستمبر 2026 · اتوار · صبح 11:30",
    countdown_note:"جب تک دو دل ایک خوبصورت سفر شروع کریں، ان شاء اللہ۔",
    closing_eyebrow:"محبت اور دعاؤں کے ساتھ",
    closing_title:"ہماری داستان کا<br><em>حصہ بننے کے لیے</em>",
    closing_note:"ہم اللہ سے دعا کرتے ہیں کہ یہ سفر سکینہ، مودّت اور رحمت سے بھرا ہو۔",
    closing_nikah:"نکاح 27 ستمبر",
    closing_walima:"ولیمہ 29 ستمبر",
    keep_duas:"ہمیں اپنی دعاؤں میں یاد رکھیے"
  }
};
...
function setLanguage(lang){
  ...
  document.documentElement.lang=next === "hi" ? "ur" : "en";
  document.body.classList.remove("lang-en","lang-hi");
  document.body.classList.add(next === "hi" ? "lang-hi" : "lang-en");
  /* Keep LTR layout so couple/event screens don't flip; Urdu script still renders correctly */
...
function stopAutoScroll(){
  ...
  clearAutoTimer();
  cancelAutoAnim();
  /* Clear any leftover content scales from older builds */
  document.querySelectorAll("#invitation .content").forEach(el=>{
