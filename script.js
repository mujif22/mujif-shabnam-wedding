...
const I18N={
  ...
  hi:{
    ...
    host_blessing:"",
    host_eyebrow:"",
    host_families:"अत्तार <em>&</em> शेख़",
    host_invite:"मुजिफ <em>&</em> शबनम के<br>मुबारक निकाह में<br>आपकी शिरकत हमारे लिए<br>बड़ी ख़ुशी और इज़्ज़त की बात होगी।",
    host_note:"आपकी आमद से<br>ये ख़ुशी और भी बढ़ जाएगी।<br><span lang=\"ar\" dir=\"rtl\">إن شاء الله</span>",
    ...
    nikah_day:"बरोज़ : इतवार",
    nikah_time:"वक़्त : सुबह 11.30 बजे",
    nikah_venue:"स्वराज मंगल कार्यालय",
    nikah_address:"तेलगांव रोड,<br>दिंद्रुड<br>ता. माजलगाव, जि. बीड",
    open_maps:"नक़्शा में देखें",
    nikah_maps:"Map पर निकाह की लोकेशन देखें",
    nikah_qr:"निकाह के मक़ाम के लिए स्कैन करें",
    nikah_qr_alt:"निकाह के मक़ाम का क्यूआर कोड",
    walima:"वलीमा",
    walima_month_year:"सितंबर<br>2026",
    walima_day:"बरोज़ : मंगलवार",
    walima_time:"वक़्त : जोहर की नमाज़ के बाद",
    walima_venue:"रुद्रा मंगल कार्यालय",
    walima_address:"पखरूड रोड,<br>ईट<br>ता. भूम, जि. धाराशिव",
    walima_maps:"Map पर वलीमा की लोकेशन देखें",
    ...
    closing_note:"अल्लाह से दुआ है कि<br>ये रिश्ता मोहब्बत, सुकून और रहमत से भरा रहे।",
