...
function applyHindiFonts(isHi){
  ...
  document.querySelectorAll(".gold-btn").forEach(el=>{
    ...
    el.style.setProperty("max-width", isHi ? "180px" : "170px", "important");
    el.style.setProperty("font-size", isHi ? "11px" : "10px", "important");
    if(isHi){
      el.style.setProperty("font-family", HI_FONT, "important");
  ...
  document.querySelectorAll(".qr-card span").forEach(span=>{
    span.style.setProperty("font-size", isHi ? "10px" : "9px", "important");
    span.style.setProperty("padding", "6px 8px", "important");
  });
