/* Old cached shells → force latest bilingual gate */
(function(){
  try{
    if(!document.querySelector(".gate-bilingual")){
      location.replace("index.html?v=65-both-" + Date.now());
      return;
    }
  }catch(_e){}
})();
...
if(openGate){
  ...
  /* Force Devanagari label — avoids cache/font showing old "Hindi" */
  openGate.querySelectorAll('[data-open-lang="hi"]').forEach(btn=>{
    btn.textContent="\u0939\u093f\u0902\u0926\u0940"; /* हिंदी */
    btn.setAttribute("lang","hi");
    btn.style.setProperty("font-family", '"Noto Sans Devanagari","Noto Serif Devanagari",sans-serif', "important");
